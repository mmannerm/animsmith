...
//! [`crate::render::print_json`] routes the output-v14 envelopes through the
...
mod tests {
    ...
    /// [`crate::render::print_json`] routes the output-v14 envelopes through
    ...
    fn pretty_json_is_produced_at_exactly_one_site() {
        ...
        assert_eq!(
            ...
            "pretty JSON has exactly one producer: `publish::serialize_record`. Evidence \
             ...
             stdout; the output-v14 envelopes reach it through `render::print_json`. Route \
