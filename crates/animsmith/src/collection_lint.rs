...
use animsmith_core::{
    ...
    CollectionSourceV1, InputIdentity, LintEnvelopeV19, Severity, SourceObservationStateV1,
...
fn execute_source(
    ...
    let envelope =
        LintEnvelopeV19::new(current_tool(), vec![report]).map_err(|error| error.to_string())?;
