...
pub const BEVY_READBACK_V1_LOCK_SHA256: &str =
    "c0715a1711f868888432eefc6096884ae4d44b374bd9758f36d7e5bcc7ca2b49";
...
mod tests {
    ...
    fn frozen_lock_identity() -> InputIdentity {
        InputIdentity::from_sha256_digest(
            [
                0xc0, 0x71, 0x5a, 0x17, 0x11, 0xf8, 0x68, 0x88, 0x84, 0x32, 0xee, 0xfc, 0x60, 0x96,
                0x88, 0x4a, 0xe4, 0xd4, 0x4b, 0x37, 0x4b, 0xd9, 0x75, 0x8f, 0x36, 0xd7, 0xe5, 0xbc,
                0xc7, 0xca, 0x2b, 0x49,
            ],
