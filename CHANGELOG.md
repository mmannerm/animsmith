...
- add canonical `rotation_xyzw` rest-world and skin-bind linear facts in
  measurements-v18; make output-v19 and collection-output-v11 the current
  contracts while retaining their pinned historical readers
