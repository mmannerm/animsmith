...
- Separate `observed`, `vendor-stated`, `documentation-stated`, `inferred`, and
  `not evaluated`. Never promote preview media or a partial sample into a claim
  about files that were not delivered.
