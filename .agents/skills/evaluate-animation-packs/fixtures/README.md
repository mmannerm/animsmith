...
`collection-output-v10-complete.json` is license-safe synthetic evidence emitted
...
LF-pinned bytes through the authoritative `read_collection_output` V10 path.
