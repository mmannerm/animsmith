...
Read and follow the [canonical skill](../../../.agents/skills/evaluate-animation-packs/SKILL.md)
completely. Resolve its relative links from the canonical
`.agents/skills/evaluate-animation-packs/` directory.

This adapter exists only because Claude Code and Codex discover project skills
from different directories. Keep all workflow instructions and resources in
the canonical `.agents` skill.
