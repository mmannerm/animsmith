...
| [Collection contract extensions](collection-contracts.md) | Read the 0.5.0 contact-fragment and transition-family contracts; 0.6 implements the contact fragment's strict core reader only. |
