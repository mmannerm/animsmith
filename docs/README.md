...
| [Collection contract extensions](collection-contracts.md) | Read the contact-fragment and transition-family contracts, including the strict standalone and manifest-selected contact-fragment producer. |
