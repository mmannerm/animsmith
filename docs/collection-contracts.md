...
selected, validated skeleton. Fixed aggregate name-byte, candidate-storage-byte,
track, authored/generated key/value, and work caps refuse before candidate
allocation. LINEAR tracks map every authored key and insert interior map-knot
