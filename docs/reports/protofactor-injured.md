...
|---|---|---|---|
| Unity 6000.5.8f1 (retained); 6000.3 advice (0.4.0) | Observed headless import/sampling (2026-08-17, unchanged); evaluator import-advice (2026-08-21) | All 70 clips import; 6/6 samples, both mixers, and the mask graph pass. 0.4.0 `unity-humanoid` import-advice exits 0, derived from delivered `.fbx.meta` root-extraction defaults (assumption stated in appendix). | Visual loops/blends/mask, controller, target rig, compression, build; 6000.3 advice is not observed 6000.5.8f1 behavior. |
