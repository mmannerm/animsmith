...
| Evaluation manifest | `mixamo-female-locomotion.manifest.json`; SHA-256 `4f0df4fda4c22806c29378f5d7b7a62cd88abc90d03324c16dc3cfdf0b0a3906`; schema `urn:animsmith:skill:animation-pack-evaluation-manifest:1` |
...
|---|---:|---:|---:|---|
| Animation files | 18 | 18 | 4 baseline warnings | Semantic file-to-manifest mapping incomplete |
