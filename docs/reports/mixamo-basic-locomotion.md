...
AnimSmith 0.14.0 — Freshly hashed source reran 996 collection-wide inspect/measure/lint commands with four workers. This constituent admitted 12/12 files; baseline and declared-contract finding counts were revalidated, and a new explicitly evaluator-owned controller hypothesis was added without recovering old semantic authority.
...
Current evidence covers 12 physical FBX files as opaque source units under evaluator revision `e8321ad40be5ef6f162b31f085819c039175c3c9`. The legacy manifest metadata says 10 motions but does not map them authoritatively to the 12 files. The immutable source inventory matched before and after evaluation; current external ledger and summary digests are recorded in the appendix. See the [canonical readiness ladder](../game-ready-clips.md#the-readiness-ladder).
