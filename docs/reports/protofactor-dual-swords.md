...
The current baseline is mechanically readable with AnimSmith 0.10.0, but this pack is not a blanket game-ready asset. 756 baseline commands completed successfully; constant-track notes and strict loop contracts require review. 25 bounded remediation candidates transformed successfully; they remain candidates pending engine, contact, and visual review.
