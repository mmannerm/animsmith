...
|---|---|
| Walk and standard run are named and measured. Idle, jump and turns appear by filename; their controller roles remain unclassified. | Filename-based candidates and current measurements; these do not establish a complete accepted gameplay controller. |
