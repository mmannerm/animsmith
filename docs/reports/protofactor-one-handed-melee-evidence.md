...
| Delivered scope | 113 FBX input candidates |
| Target use | Engine use; no target controller supplied |
| Target engines | Not evaluated |
| Target rigs/packs | Not evaluated |
| Source manifest | External source inventory, SHA-256 `d70f848f52c11918d90f02f460455cc98b20cacda292cc5b7ae71f733027a5a7` |
...
|---|---:|---:|---:|---|
| Animation files | 113 | 113 | Mechanical baseline completed | N/A |
| Rigs/export variants | 112 animation-bearing candidates | partial | Mechanical inspection only | Runtime compatibility not run |
| AnimSmith baseline | 113 | 113 | 452 baseline commands completed successfully; constant-track notes and strict loop contracts require review. | N/A |
| Declared contracts | 110 selected motion inputs | 110 | 110 declared-contract inputs: 23 clean and 87 non-clean results in each output format. | Engine behavior is out of scope |
...
Current inventory found 113 FBX candidates, including 112 animation-bearing candidates, 110 individual-motion candidates, and 1 combined-take candidates. This establishes source presence and mechanical coverage only.

## Mechanical baseline

| Finding/check | Affected scope | Potential impact | Evidence |
|---|---|---|---|
| Baseline commands | 113/113 | Inputs are mechanically readable by the current evaluator | `observed-animsmith`; 452 baseline commands completed successfully; constant-track notes and strict loop contracts require review. |
| Declared contracts | 110 selected inputs | Non-clean strict contract results require clip-level admission | `observed-animsmith`; 110 declared-contract inputs: 23 clean and 87 non-clean results in each output format. |
