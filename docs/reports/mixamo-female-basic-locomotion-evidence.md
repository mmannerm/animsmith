...
| Delivered scope | 20 extracted FBX files from paired archive variants |
...
| Evaluation manifest | `mixamo-female-basic-locomotion.manifest.json`; SHA-256 `65abc6c475347a4af412e890432203405988ab147d7a99dd57dd6a5700833b0f`; schema `urn:animsmith:skill:animation-pack-evaluation-manifest:1` |
...
| `other-unknown` | 20 | 20 | One opaque unit per delivered FBX; no semantic classification asserted |
| **Total** | **20** | **20** | Validated scrubbed external manifest |
...
| Root motion | `partially-evaluated` | In-place XZ contract has 0 errors and 2 duration warnings; root-motion XZ contract has 6 stationary-root errors and 3 duration warnings; per-clip ownership remains open |
