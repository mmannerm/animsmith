...
3. **State ownership:** `owner=split-by-movement-variant`; the controller owns in-place translation/yaw at deliberate per-direction speeds, animation owns root-motion translation/yaw. Preserve trajectories when applying phase offsets.
