...
| Evaluation manifest | `mixamo-basic-locomotion.manifest.json`; SHA-256 `345923251a496e41610ac2593e04312935db7bbf13cf0a86a5bb045b5e7461f4`; schema `urn:animsmith:skill:animation-pack-evaluation-manifest:1` |
...
|---|---:|---:|---:|---|
| Animation files | 12 | 12 | 4 baseline warnings | Semantic file-to-manifest mapping incomplete |
| Rigs/export variants | 1 | 1 | Mixamo profile used | Retarget behavior unavailable |
| AnimSmith baseline | 12 | 12 | 0 errors | — |
| Declared contracts | 12 | 12 | 4 variant-contract findings | Per-clip intent unavailable |
...
|---|---|---|---|
| No mechanical errors | 12 files | File-ready mechanical health only | observed-animsmith |
| `duration-sanity` warnings | 4 files | No-track assets/clips require semantic classification | observed-animsmith |
