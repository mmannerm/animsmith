...
| Evaluation manifest | `mixamo-longbow-locomotion.manifest.json`; SHA-256 `317fa928cb79eef6dd447e936438a9114100d47ae6b8191af1dd53111e137336`; schema `urn:animsmith:skill:animation-pack-evaluation-manifest:1` |
...
|---|---:|---:|---:|---|
| Animation files | 22 | 22 | 3 baseline warnings | Semantic file-to-manifest mapping incomplete |
| Rigs/export variants | 1 | 1 | Mixamo profile used | Retarget behavior unavailable |
| AnimSmith baseline | 22 | 22 | 0 errors | — |
| Declared contracts | 22 | 22 | 3 variant-contract findings | Per-clip intent unavailable |
...
|---|---|---|---|
| No mechanical errors | 22 files | File-ready mechanical health only | observed-animsmith |
| `duration-sanity` warnings | 3 files | No-track assets/clips require semantic classification | observed-animsmith |
