...
AnimSmith 0.10.0 mechanically inspected, measured, and linted all 18 extracted FBX files. The untouched baseline has 0 errors, 4 warnings, and 2,559 non-gating constant-track notes; these are file-ready evidence only, not gameplay or engine acceptance. The declared in-place XZ contract has 0 errors and 2 duration warnings; the declared root-motion contract has 4 stationary-root errors and 2 duration warnings. No source bytes were changed. [The readiness ladder](../game-ready-clips.md#the-readiness-ladder) remains the governing boundary.
...
- The in-place XZ declaration has 0 errors but 2 duration warnings; 4 root-motion-labelled files have stationary roots and that declaration has 2 duration warnings. Per-clip movement ownership is still not established.
...
18 delivered FBX files and 16 manifest-declared motions were evaluated mechanically with AnimSmith 0.10.0 at revision `db91d8dda3326f97f581d4d62104d928caec383f`. Fresh external inventories and scrubbed SHA-256 identities are retained outside the repository. The companion appendix records the schema and open evidence gates.
