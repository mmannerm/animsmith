...
|---|---:|---:|---|
| Basic Locomotion | 179 | 177 | baseline, declared contracts, and 39 external transform candidates |
| Sword & Shield | 136 | 132 | baseline, declared contracts, and 28 external transform candidates |
| Campfire | 29 | 25 | baseline, declared contracts, and 1 external transform candidate |
| Climbing | 77 | 75 | baseline, declared contracts, and 1 external transform candidate |
| Injured | 72 | 70 | baseline, declared contracts, and 15 external transform candidates |
...
| Basic Locomotion | 12 slices, 24 gait anchors, and 3 constant-track prunes | 39/39 commands emitted candidates | Post-output inspect, measure, diff, and lint recorded externally | Candidate quality and engine use remain unaccepted |
| Campfire and Climbing | One constant-track prune each | 2/2 commands emitted candidates | Post-output inspect, measure, diff, and lint recorded externally | Candidate quality and engine use remain unaccepted |
| Injured | 14 gait anchors and one constant-track prune | 15/15 commands emitted candidates | Post-output inspect, measure, diff, and lint recorded externally | Candidate quality and engine use remain unaccepted |
