...
- 123 delivered FBX candidates were inspected, measured, and linted in both output formats.
- Declared contracts and bounded remediation trials were rerun with the current evaluator.

### Partial supporting gameplay

- 120 declared-contract inputs: 13 clean and 107 non-clean results in each output format.
...
See the [readiness ladder](../game-ready-clips.md#the-readiness-ladder) and [appendix](protofactor-two-handed-melee-evidence.md). Mechanical completion is separate from engine and visual acceptance.
