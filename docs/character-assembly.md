...
a second recipe namespace. An explicit selection that retains no skinned base
instance refuses as an `asset-recipe-mismatch` at the selection boundary; its
diagnostic names the recipe selection rather than the private staging artifact.
